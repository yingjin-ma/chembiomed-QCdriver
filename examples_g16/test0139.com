...
density=curr guess=read extrabasis int=nobasistrans
mdv=7400000 iop(1/2=-1,2/2=-1)
...
guess=read mdv=7400000 iop(1/2=-1,2/2=-1)
...
--Link1--
%chk=test0139
#p rmp2/D95(df,p) 5d 7f test geom=modela guess=read mdv=7400000 iop(1/2=-1,2/2=-1)
...
%chk=test0139
#p rmp2=fulldirect/D95(df,p) 5d 7f test geom=modela density=curr 
guess=read force iop1=nopacksort mdv=7400000 iop(1/2=-1,2/2=-1)
...
%chk=test0139
#p rmp2=semidirect=1/D95(df,p) 5d 7f test geom=modela density=curr 
guess=read iop1=nopacksort mdv=7400000 iop(1/2=-1,2/2=-1)
...
%chk=test0139
#p rmp2/D95(df,p) 5d 7f test geom=modela density=curr 
guess=read iop1=nopacksor mdv=7400000 iop(1/2=-1,2/2=-1)
