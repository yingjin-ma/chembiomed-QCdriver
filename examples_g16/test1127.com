%chk=test1127
%mem=1gb
#p upbe1pbe/sto-3g extrabasis 5d freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 1):
...
%chk=test1127
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine) iop(5/29=3) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 2):
...
%chk=test1127
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 3):
...
%chk=test1127
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine) raff fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 4):
...
%chk=test1127
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine,sepk) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 5):
...
%chk=test1127
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine) iop(5/29=3) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 6):
...
%chk=test1127
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine) raff nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 7):
frequencies, forcing cart digestion, mix reg/raf
...
%nosave
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digcart,ultrafine,sepk) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1127 (Part 8):
