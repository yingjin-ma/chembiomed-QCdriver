%chk=test1065
#p oniom(mp2/6-31G(d):blyp/3-21g/auto:uff)=(embed,scale=5) scrf=(smd,oniompcm=(A,potential),read) 5d 7f test int(grid=ultrafine)

Gaussian Test Job 1065 (Part 1)
...
%chk=test1065
%nosave
#p oniom(mp2/6-31G(d):blyp/3-21g/auto:uff)=(embed,scale=5) scrf=(smd,oniompcm=(A,potential),1stvac,check) 5d 7f test int(grid=ultrafine)
geom(check) guess(check)

Gaussian Test Job 1065 (Part 2)
Closed shell ONIOM(QM:QM:MM)-PCM-A energy.
