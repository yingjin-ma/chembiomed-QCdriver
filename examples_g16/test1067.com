%chk=test1067
#p oniom(b3lyp/6-31G(d):pm6:uff)=(embed,scale=5) scrf=(smd,oniompcm=A,read) 5d 7f test int(grid=ultrafine)

Gaussian Test Job 1067 (Part 1)
Closed shell ONIOM(QM:SE:MM)-PCM-A energy.
...
%chk=test1067
%nosave
#p oniom(b3lyp/6-31G(d):pm6:uff)=(embed,scale=5) scrf=(smd,oniompcm=A,1stvac,check) 5d 7f test int(grid=ultrafine)
geom(check) guess(check)

Gaussian Test Job 1067 (Part 2)
Closed shell ONIOM(QM:SE:MM)-PCM-A energy.
