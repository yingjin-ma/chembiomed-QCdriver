%chk=test0916
#p oniom(hf/3-21g:uff)=embed scrf(smd,oniompcm=C) test force

Gaussian Test Job 916 (Part 1):
...
--Link1--
%chk=test0916
#p oniom(hf/3-21g:uff)=embed scrf(smd,oniompcm=C) test freq geom=check guess=read

Gaussian Test Job 916 (Part 2):
...
--Link1--
%chk=test0916
#p oniom(hf/3-21g:uff)=embed scrf=smd test force geom=check guess=read

Gaussian Test Job 916 (Part 3):
