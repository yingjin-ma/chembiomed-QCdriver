...
--link1--
%chk=test0615
#p cas(4,3,nroot=2)/sto-3g guess=(read) nosymm scrf(dpcm,read) test

Gaussian Test Job 615 (Part 3):
TEST PCM 2: energies MC-SCF 
...
--link1--
%chk=test0615
#p cas(4,3,nroot=2)/sto-3g guess=(read) nosymm scrf(cpcm,read) test

Gaussian Test Job 615 (Part 7):
TEST PCM 2: energies MC-SCF 
