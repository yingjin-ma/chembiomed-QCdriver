%chk=test1119
%mem=1gb
#p rhf/sto-3g extrabasis 5d freq test scf=(novaracc,noincore) int=(ultrafine) nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 1):
...
%chk=test1119
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine) iop(5/29=3) fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 2):
...
%chk=test1119
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine) fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 3):
...
%chk=test1119
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine) raff fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 4):
...
%chk=test1119
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine,sepk) fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 5):
...
%chk=test1119
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine) iop(5/29=3) nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 6):
...
%chk=test1119
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine) raff nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 7):
frequencies, default choice of digestion, mix reg/raf
...
%nosave
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(ultrafine,sepk) nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1119 (Part 8):
