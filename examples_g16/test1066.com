%chk=test1066
#p oniom(b3lyp/6-31G(d):pm6) scrf=(smd,oniompcm=A,read) 5d 7f test int(grid=ultrafine)

Gaussian Test Job 1066 (Part 1)
Closed shell ONIOM(QM:SE)-PCM-A energy.
...
%chk=test1066
%nosave
#p oniom(b3lyp/6-31G(d):pm6) scrf=(smd,oniompcm=A,1stvac,check) 5d 7f test int(grid=ultrafine)
geom(check) guess(check)

Gaussian Test Job 1066 (Part 2)
Closed shell ONIOM(QM:SE)-PCM-A energy.
