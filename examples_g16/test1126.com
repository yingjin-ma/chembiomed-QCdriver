%chk=test1126
%mem=1gb
#p upbe1pbe/sto-3g extrabasis 5d freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 1):
frequencies, forcing pure digestion
...
%chk=test1126
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) iop(5/29=3) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 2):
frequencies, forcing pure digestion, fmm, mixed reg/raf
...
%chk=test1126
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 3):
frequencies, forcing pure digestion, fmm
...
%chk=test1126
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) raff fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 4):
frequencies, forcing pure digestion, fmm, raff
...
%chk=test1126
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine,sepk) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 5):
frequencies, forcing pure digestion, fmm, sepk
...
%chk=test1126
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) iop(5/29=3) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 6):
frequencies, forcing pure digestion, mix reg/raf
...
%chk=test1126
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) raff nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 7):
frequencies, forcing pure digestion, mix reg/raf
...
%nosave
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine,sepk) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1126 (Part 8):
frequencies, forcing pure digestion, sepk
