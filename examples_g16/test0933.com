%chk=test0933
%mem=64mw
#p ONIOM(b3lyp/6-31G(d):uff)=scalecharge=5 test freq=roa cphf=rdfreq

Gaussian Test Job 933 (Part 1):
...
Gaussian Test Job 933 (Part 2):
ROA with ONIOM and EE, tensor derivatives with larger basis
