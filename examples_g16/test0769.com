%chk=test0769
#p freq=noraman oniom(external="mygau o g16 b3lyp 6-311G\(d\,p\)":uff=qeq) nosymm geom=connectivity test
...
--Link1--
%chk=test0769
#p freq=noraman oniom(external=("mygau c g16 b3lyp 6-311G\(d\,p\)",iofchk)/6-311g**:uff=qeq) nosymm geom=check test
...
--Link1--
%chk=test0769
#p freq=noraman oniom(external=("mygau c g16 b3lyp 6-311G\(d\,p\)",iofchk,1elect)/6-311g**:uff=qeq) nosymm geom=check test
...
%chk=test0769
%nosave
#p freq=noraman oniom(external=("mygau c g16 b3lyp 6-311G\(d\,p\)",iofchk,2elect)/6-311g**:uff=qeq) nosymm geom=check test
