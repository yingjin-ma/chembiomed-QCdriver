%chk=test1121
%mem=1gb
#p rhf/sto-3g extrabasis 5d freq test scf=(novaracc,noincore) int=(digcart,ultrafine) nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 1):
...
%chk=test1121
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine) iop(5/29=3) fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 2):
...
%chk=test1121
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine) fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 3):
...
%chk=test1121
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine) raff fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 4):
...
%chk=test1121
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine,sepk) fmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 5):
...
%chk=test1121
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine) iop(5/29=3) nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 6):
...
%chk=test1121
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine) raff nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 7):
frequencies, forcing cart digestion, mix reg/raf
...
%nosave
%mem=1gb
#p rhf/chkbas 5d geom=check freq test scf=(novaracc,noincore) int=(digcart,ultrafine,sepk) nofmm
int=acc2e=12 scf=conver=10 cphf=(conver=10,simult)

Gaussian Test Job 1121 (Part 8):
