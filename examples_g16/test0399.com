%chk=test0399
%mem=100mw
#P b3lyp td=(nstates=6,incore)/6-31+g* 5d test
 
Gaussian Test Job 399 (Part 1):
Benzene d6h TD-DFT, in-core
...
%chk=test0399
%mem=100mw
#P b3lyp td=(nstates=6,noincore)/6-31+g* 5d test geom=check guess=read

Gaussian Test Job 399 (Part 2):
Benzene d6h TD-DFT, direct
...
Gaussian Test Job 399 (Part 5):
Benzene d6h UTD-DFT, odd number of states
