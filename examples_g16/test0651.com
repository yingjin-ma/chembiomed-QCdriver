...
HCHO with D95(d) basis. MOD method is used and full-valence active MOs
are adopted (FC; default). MacroIteration = 1.
...
A" state of HCHO with full-valence active MOs of D95(d) basis.
Initial geometry is the experimental one (Cs).
