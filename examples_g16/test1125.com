%chk=test1125
%mem=1gb
#p upbe1pbe/sto-3g extrabasis 5d freq=raman test scf=(novaracc,noincore) int=(ultrafine) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 1):
...
%chk=test1125
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine) iop(5/29=3) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 2):
...
%chk=test1125
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 3):
...
%chk=test1125
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine) raff fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 4):
...
%chk=test1125
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine,sepk) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 5):
...
%chk=test1125
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine) iop(5/29=3) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 6):
...
%chk=test1125
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine) raff nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 7):
frequencies, default choice of digestion, mix reg/raf
...
%nosave
%mem=1gb
#p upbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(ultrafine,sepk) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1125 (Part 8):
