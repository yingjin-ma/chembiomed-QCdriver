%chk=test1063
#p oniom(mp2/6-31G(d):blyp/3-21g/auto) scrf=(smd,oniompcm=(A,potential),read) 5d 7f test int(grid=ultrafine)

Gaussian Test Job 1063 (Part 1)
...
%chk=test1063
%nosave
#p oniom(mp2/6-31G(d):blyp/3-21g/auto) scrf=(smd,oniompcm=(A,potential),1stvac,check) 5d 7f test int(grid=ultrafine)
geom(check) guess(check)

Gaussian Test Job 1063 (Part 2)
Closed shell ONIOM(QM:QM)-PCM-A energy.
