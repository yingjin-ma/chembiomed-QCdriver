#p uhfs/6-31G(df,p) 5d 7f test geom=modela freq mdv=7200000 iop(1/2=-1,2/2=-1)
...
--Link1--
#p uxalpha/6-31G(df,p) 5d 7f test geom=modela freq mdv=7200000 iop(1/2=-1,2/2=-1)
...
--Link1--
#p uhfb/6-31G(df,p) 5d 7f test geom=modela freq mdv=7200000 iop(1/2=-1,2/2=-1)
...
--Link1--
#p usvwn5/6-31G(df,p) 5d 7f test geom=modela freq mdv=7200000 iop(1/2=-1,2/2=-1)
...
--Link1--
#p uslyp/6-31G(df,p) 5d 7f test geom=modela freq mdv=7200000 iop(1/2=-1,2/2=-1)
