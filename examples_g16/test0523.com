%chk=test0523
#p opt freq oniom(qcisd/lanl2dz:mp2/lanl2mb) test

Gaussian Test Job 523:
...
--Link1--
%chk=test0523
#p polar=numer oniom(qcisd/lanl2dz:mp2/lanl2mb) test
geom=allcheck guess=read

--Link1--
%chk=test0523
#p polar=enonly oniom(qcisd/lanl2dz:mp2/lanl2mb) test
geom=allcheck guess=read
