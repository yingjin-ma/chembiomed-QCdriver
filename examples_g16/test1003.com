%chk=test1003
#p hf/3-21g nosymm force nofmm test int(acc2e=12) scf(novaracc,conver=11)

Gaussian Test Job 1003 (Part 1)
...
--Link1--
%chk=test1003
#p hf/3-21g nosymm geom(check) guess(check) force int(sepk) nofmm test
int(acc2e=12) scf(novaracc,conver=11)

Gaussian Test Job 1003 (Part 2)
...
--Link1--
%chk=test1003
#p hf/3-21g nosymm geom(check) guess(check) force int(sepk) fmm(noboxbox) test
int(acc2e=12) scf(novaracc,conver=11)

Gaussian Test Job 1003 (Part 4)
...
--Link1--
%chk=test1003
#p hf/3-21g nosymm geom(check) guess(check) force fmm test
int(acc2e=12) scf(novaracc,conver=11)

Gaussian Test Job 1003 (Part 5)
