%chk=test1123
%mem=1gb
#p rpbe1pbe/sto-3g extrabasis 5d freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 1):
...
%chk=test1123
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) iop(5/29=3) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 2):
...
%chk=test1123
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 3):
...
%chk=test1123
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) raff fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 4):
...
%chk=test1123
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine,sepk) fmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 5):
...
%chk=test1123
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) iop(5/29=3) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 6):
...
%chk=test1123
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine) raff nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 7):
frequencies, forcing pure digestion, mix reg/raf
...
%nosave
%mem=1gb
#p rpbe1pbe/chkbas 5d geom=check freq=raman test scf=(novaracc,noincore) int=(digpure,ultrafine,sepk) nofmm
int=(acc2e=12) scf=conver=10 cphf=(ultrafine,conver=10,simult)

Gaussian Test Job 1123 (Part 8):
