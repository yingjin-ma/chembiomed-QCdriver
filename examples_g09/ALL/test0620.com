%chk=test0620
%mem=24mw
#P ulsda/6-31g**/dga1 5d stable=opt test
 
Gaussian Test Job 620:
...
%chk=test0620
%mem=24mw
#p ulsda/chkbas/chkbas opt freq scf=idsymm geom=allcheck guess=read test
