...
%chk=test0627
%mem=50mw
#P CASSCF(22,22,rasscf(1,9,1,9),nroot=3)/STO-3G guess=read geom=check test scf=tight
scfcyc=3 iop(5/13=1,5/106=1)

Gaussian Test Job 627 (Part 3):
s-trans buta-1,3-diene CASSCF(4,4)/6-31G* optimised 1Ag state
RASSCF(22,22)/STO-3G: full valence RASSCF (single excitations only!)
Single point calculation of 1Ag stops partway through
...
%chk=test0627
%mem=50mw
#P CASSCF(22,22,rasscf(1,9,1,9),nroot=3)/STO-3G geom=check test guess=read scf=tight
iop(5/106=3)

Gaussian Test Job 627 (Part 4):
s-trans buta-1,3-diene CASSCF(4,4)/6-31G* optimised 1Ag state
RASSCF(22,22)/STO-3G: full valence RASSCF (single excitations only!)
Single point calculation of 1Ag, restart of MOs and CI.
...
Gaussian Test Job 627 (Part 5):
s-trans buta-1,3-diene CASSCF(4,4)/6-31G* optimised 1Ag state
RASSCF(22,22)/STO-3G: full valence RASSCF (single excitations only!)
Single point calculation of 1Ag, adding new CI vectors
