%mem=96Mw
#p rhf/6-31G(df,p) 5d 7f test freq=roa cphf=(rdfreq,conver=10,grid=ultrafine)
int=ultrafinegrid scf(conver=10) field=Y-50 scrf=read int=acc2e=12

Gaussian Test Job 850 (Part 1):
...
field=Y-50 scrf=read int=acc2e=12

Gaussian Test Job 850 (Part 4):
