...
%chk=test0100
%kjob l301 4
# TEST force=enonly RHF/6-31G* 5D geom=check guess=read
...
--Link1--
%chk=test0100
# TEST force=(enonly,restart) RHF/6-31G* 5D geom=check guess=read
...
%chk=test0100
%kjob l301 5
# TEST freq=enonly RHF/6-31G* 5D geom=check guess=read
