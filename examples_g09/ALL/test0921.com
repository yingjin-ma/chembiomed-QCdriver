...
# SAC-CI(Singlet=(NState=(0,0,0,0,0,4,4,1)),
        Window=(25,244)  MaxR2Op=600000 
        Direct)/Gen Test

Gaussian Test Job 921:
Direct SAC-CI SD-R LevelThree calculation of optically-allowed 
singlet excited states of Free-Base Porphin using Huzinaga basis 
sets [4s2p/2s].  Inner-shells are excluded from the active space 
and full-valence active MOs are used (FC; default): 57 occupied 
and 163 unoccupied MOs are included in the active space of SAC-CI.
