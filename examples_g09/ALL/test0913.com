%chk=test0913
#p oniom(mp2/3-21g:pm6) scrf(smd,oniompcm=C) test force

Gaussian Test Job 913 (Part 1):
...
--Link1--
%chk=test0913
#p oniom(mp2/3-21g:pm6) scrf(smd,oniompcm=C) test freq geom=check guess=read

Gaussian Test Job 913 (Part 2):
...
--Link1--
%chk=test0913
#p oniom(mp2/3-21g:pm6) scrf=smd test force geom=check guess=read

Gaussian Test Job 913 (Part 3):
