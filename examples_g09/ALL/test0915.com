%chk=test0915
#p oniom(pm6:uff) scrf(smd,oniompcm=C) test force
...
--Link1--
%chk=test0915
#p oniom(pm6:uff) scrf(smd,oniompcm=C) test freq geom=check guess=read
...
--Link1--
%chk=test0915
#p oniom(pm6:uff) scrf=smd test force geom=check guess=read
