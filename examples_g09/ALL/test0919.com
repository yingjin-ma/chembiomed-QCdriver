%chk=test0919
#p oniom(hf/sto-3g:uff) scrf(smd,oniompcm=C) test force

Gaussian Test Job 919 (Part 1):
...
--Link1--
%chk=test0919
#p oniom(hf/sto-3g:uff) scrf(smd,oniompcm=C) test freq=noraman geom=check guess=read

Gaussian Test Job 919 (Part 2):
...
--Link1--
%chk=test0919
#p oniom(hf/sto-3g:uff) scrf=smd test force geom=check guess=read

Gaussian Test Job 919 (Part 3):
