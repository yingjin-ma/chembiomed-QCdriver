%chk=test0410
#p opt=tight freq oniom(hf/sto-3g:am1) test scfcon=10 cphf=conver=10 int=acc2e=12
...
--Link1--
%chk=test0410
#p freq=(numer,four) polar oniom(hf/sto-3g:am1) test geom=check guess=read scfcon=10 cphf=conver=10 int=acc2e=12
