%Kjob l103 3
%chk=test0839
#p oniom(am1:uff) scrf(oniompcm=C,read) 5d 7f test
int(grid=ultrafine) opt(tight)

Gaussian Test Job 839 (Part 1)
Closed shell ONIOM(SE:MM)-PCM-C optimization.
...
--Link1--
%chk=test0839
#p oniom(am1:uff) scrf(oniompcm=C,check) 5d 7f test
int(grid=ultrafine) opt(tight,restart)

Gaussian Test Job 839 (Part 2)
Closed shell ONIOM(SE:MM)-PCM-C optimization -- restart.
...
Gaussian Test Job 839 (Part 3)
Closed shell ONIOM(SE:MM)-PCM-X optimization.
...
Gaussian Test Job 839 (Part 4)
Closed shell ONIOM(SE:MM)-PCM-X optimization -- restart.
